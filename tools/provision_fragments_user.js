...
function main() {
  ...
  const avatarExists = avatar ? fs.existsSync(path.resolve(__dirname, '..', avatar)) : false;
  ...
  console.log(`2. ${avatar ? (avatarExists ? 'Avatar file confirmed.' : 'Add the avatar file first.') : 'Avatar still needed.'} (${avatar || 'not set yet'})`);
