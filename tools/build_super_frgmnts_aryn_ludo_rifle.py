...
def main() -> None:
    ...
    manifest = {
        ...
        "design_contract": {
            "production_default": "backpack telescopic laser seeker",
            "rifle_role": (
                "optional special weapon for Vesperite route clearing, "
                "boss killing, and heavy combat"
            ),
            "mobility_tradeoff": (
            ...
            "destruction_target": (
                "Vesperite route obstructions, armored enemies, and bosses"
            ),
            "combat_balance": (
                "ammo, damage, boss durability, and armor interactions "
                "remain undecided"
            ),
            "preview_only": False,
        ...
        "notes": [
            ...
            "Once fired, the rifle stays shouldered until Aryn explicitly switches weapons or leaves the scene.",
            "Grounded idle time does not automatically holster the rifle.",
