...
for fragment, label in [
    ...
    ("var denseShardClips", "low-cost dense-section fracture map"),
    ('var clips = elementCount > 45 ? denseShardClips : shardClips', "complexity-aware shard budget"),
    ("else window.setTimeout(createShard, index * 16)", "frame-spread shard creation"),
