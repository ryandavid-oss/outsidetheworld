...
Status: Revision 3H local review candidate. Production remains untouched.
...
- The Coreworks volcano keeps the approved plate intact. A screen-blended
  runtime layer adds restrained orange crater heat, cyan Resonant flow along
  the already-painted fissures, and small travelling essence sparks.
...
- A small weathered camp dog occupies local plate-two X 810. Its head searches
  a scrap container, then it walks 130 pixels toward the shelter on a two-frame
  gait, pauses, and returns. Its cyan collar ties it to the outpost technology.
