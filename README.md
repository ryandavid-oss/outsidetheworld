...
- `image_manifest.json`
- `frontpage_payload.json` (generated by `tools/build_frontpage_payload.py`)
- `insta_manifest.json`
- `shirt_scripting.json`
- `poetry_data.js`
- `narrative_data.js`
- `narrative_index.json` (generated by `tools/build_narrative_index.py`)
- `responsive_media.json`
- `wayback_purified.js`
